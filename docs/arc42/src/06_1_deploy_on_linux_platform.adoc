...
|xs2a-connector-examples | Java 17 | SPRING_PROFILES_ACTIVE | 8089,8189
...
| | |DB_DATABASE |
| | |DB_HOST |
|xs2a-aspsp--profile |Java 17 | SPRING_PROFILES_ACTIVE | 48080
| | | XS2A_BANK_PROFILE_PATH |
|xs2a-consent-management |Java 17 | ASPSP-PROFILE_BASEURL | 38080
...
| | | TPP_REST_SERVER_URL |
| | | CERT_GEN_URL |
| xs2a-tpp-rest-server | Java 17 | LEDGERS_URL | 8093
| | | SPRING_DATASOURCE_URL  |
| | | SPRING_DATASOURCE_USERNAME  |
| | | SPRING_DATASOURCE_PASSWORD  |
| | | SERVER_KEY  |
...
| | | POSTGRESQL_USER  |
| | | POSTGRESQL_PASSWORD |
|certificate-generator | Java 17 | - | 8092
...
Manual to install Java 17 on linux server:
