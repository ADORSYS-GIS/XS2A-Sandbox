...
This is the actual business configuration reflecting the PSD2 features your bank offers. You can find the relevant documentation for this file at the https://git.adorsys.de/adorsys/xs2a/aspsp-xs2a/-/blob/master/aspsp-profile/README.adoc[XS2A GitLab Project].
...
| SANDBOX_UI_CONTACT_MAILTO                       | Contact email address
 ...
 Format: _mailto:YOUR@MAILADRESS.DE_ | sales@adorsys.com
