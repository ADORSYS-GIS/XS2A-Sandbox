...
* xref:release_notes/Release_notes_7.7.md[Version 7.7 (release date: xx.xx.2023)]
...
* xref:release_notes/Release_notes_6.7.md[Version 6.7 (release date: xx.xx.2023)]
