...
* xref:release_notes/Release_notes_7.8.md[Version 7.8 (release date: xx.xx.2023)]
...
* xref:release_notes/Release_notes_6.8.md[Version 6.8 (release date: xx.xx.2023)]
