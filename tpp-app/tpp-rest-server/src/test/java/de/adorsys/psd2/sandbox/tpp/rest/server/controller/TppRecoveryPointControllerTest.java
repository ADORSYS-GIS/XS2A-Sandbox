...
class TppRecoveryPointControllerTest {
    ...
    void createPoint() {
        // Given
        when(dataRestClient.createPoint(any(RecoveryPointTO.class))).thenReturn(new ResponseEntity<>(HttpStatus.valueOf(200)));
    ...
    void deletePoint() {
        // Given
        when(dataRestClient.deletePoint(any(Long.class))).thenReturn(new ResponseEntity<>(HttpStatus.valueOf(200)));
