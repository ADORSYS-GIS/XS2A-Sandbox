...
@Tag(name = "Admin Accounts management")
public interface AdminAccountsRestApi {

    String BASE_PATH = "/admin/accounts";
    ...
    @SecurityRequirement(name = "apiKey")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = AccountDetailsTO[].class)), description = "Account details by its ID if it is accessible by the TPP.")
    })
    ...
    @SecurityRequirement(name = "apiKey")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = AccountReportTO.class)), description = "Account report by its ID if it is accessible by the TPP.")
    })
