...
import de.adorsys.psd2.sandbox.admin.rest.api.resource.AdminRestApi;
...
class DisableEndpointFilterTest {
    ...
    void doFilterInternal_uri_not_present_in_map() throws IOException, ServletException {
        ...
        when(request.getServletPath()).thenReturn(AdminBaseRestApi.BASE_PATH + "/login");
    ...
    void doFilterInternal_uri_is_in_map_not_in_profile() throws IOException, ServletException {
        // Given
        SecurityContextHolder.clearContext();
        when(request.getServletPath()).thenReturn(AdminBaseRestApi.BASE_PATH + "/register");
