...
class AdminExceptionAdvisorTest {
    ...
    @InjectMocks
    private AdminExceptionAdvisor service;
    ...
    void handleTppException() throws NoSuchMethodException {
        // When
        ResponseEntity<Map> result = service.handleTppException(new AdminException("Msg", 500), new HandlerMethod(service, "toString", null));
        ResponseEntity<Map<String, String>> expected = ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(getExpected(500, "Msg"));
